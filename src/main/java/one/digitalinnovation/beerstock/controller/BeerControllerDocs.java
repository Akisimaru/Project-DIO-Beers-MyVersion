...
import one.digitalinnovation.beerstock.exception.FabricationDateIsInTheFuture;
...
public interface BeerControllerDocs {
    ...
    BeerDTO createBeer(BeerDTO beerDTO) throws BeerAlreadyRegisteredException, FabricationDateIsInTheFuture;
